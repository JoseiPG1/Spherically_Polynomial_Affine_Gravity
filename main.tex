...
\begin{aligned}
    ...
    \ctG{t}{\theta}{\theta} & = Z(t,r) & \ctG{t}{\theta}{\phi} & = -D(t,r)\sin\theta & \ctG{r}{\theta}{\theta} & = G(t,r) & \ctG{r}{\theta}{\phi} & = -H(t,r)\sin\theta & \ctG{\phi}{\theta}{\phi} & = -\cos\theta\sin\theta \\
    \ctG{t}{\phi}{\theta} & = \frac{D(t,r)}{\sin\theta} & \ctG{t}{\phi}{\phi} & = Z(t,r) & \ctG{r}{\phi}{\theta} & = \frac{H(t,r)}{\sin\theta} & \ctG{r}{\phi}{\phi} & = G(t,r) & \ctG{\theta}{\phi}{\phi} & = \frac{\cos\theta}{\sin \theta}
\end{aligned}
\end{equation}
