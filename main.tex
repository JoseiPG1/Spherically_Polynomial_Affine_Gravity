...
\begin{align}
\frac{bc(a')^2 - 2abca'' + aca'b' - 2aba'c'}{4ab^2 c} & = \Lambda a \\
\frac{\left(bc^2(a')^2 - 2abc^2a'' + ac^2a'b' + 2a^2cb'c' + 2a^2b(c')^2 - 4a^2bcc''\right)}{4a^2bc^2} = \Lambda b \\
\frac{4ab^2 - 2abc'' - c'\left(ba' - ab'\right)}{4ab^2} & = \Lambda c
\end{align}
