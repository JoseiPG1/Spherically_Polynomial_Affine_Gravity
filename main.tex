...
written as follow
\begin{align}
    0 & = \frac{\partial^2 B}{\partial r^2} + B\left(\frac{\partial C}{\partial r} + 2\frac{\partial G}{\partial r} - \frac{\partial A}{\partial r}\right) -\frac{\partial B}{\partial r}\left(3A - C - 2G\right)
    + 2AB\left(A - C - 2G\right)  \\
